...
export async function generateMetadata({ params }) {
    ...
    const slug = resolvedParams?.['api-pages'];
    ...
    try {
        ...
        if (!cmsPage || cmsPage.category !== CMS_CATEGORY_BY_ROUTE.service) {
            return { title: "Page Not Found" };
        }
        ...
        return {
            ...
            alternates: {
                canonical: `https://www.base2brand.com/service/${slug}`,
            },
            openGraph: {
                title: cmsPage.metaTitle || cmsPage.name,
                description: cmsPage.metaDescription,
                url: `https://www.base2brand.com/service/${slug}`,
            },
        };
    } catch {
        return { title: "Page Not Found" };
